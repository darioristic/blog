...
export const metadata = {
  ...
  openGraph: {
    title: "About - Dario Ristic",
    description:
      "Technology executive with 20+ years building cloud platforms, development products, leading teams, and creating companies that bridge innovation and business value.",
...
>
  <Image
    src={darioPhoto}
    alt="Dario Ristic - Technology Executive and Consultant"
