export const metadata = {
  alternates: {
    canonical: "/2017/how-i-use-obsidian-for-my-second-brain",
    types: {
  ...
  openGraph: {
    type: "article",
    url: "https://darioristic.com/2017/how-i-use-obsidian-for-my-second-brain",
    siteName: "Dario Ristić's blog",
    publishedTime: "2017-01-15",
...
You're probably reading this because you've heard about [Obsidian's](https://obsidian.md/) bidirectional linking or its graph view, and you're wondering if it's worth the complexity. Maybe you've tried Notion or Evernote and found them too limiting for the way you think. Or maybe you've been building a Second Brain in various tools and nothing quite fits how your mind works.

If you're just starting out, check out [A Guide to Building Your Digital Knowledge Hub](/2017/a-guide-to-building-your-digital-knowledge-hub) for the foundational principles before diving into specific tools.
