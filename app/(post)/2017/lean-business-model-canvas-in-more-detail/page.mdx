export const metadata = {
  alternates: {
    canonical: "/2017/lean-business-model-canvas-in-more-detail",
    types: {
  ...
  openGraph: {
    type: "article",
    url: "https://darioristic.com/2017/lean-business-model-canvas-in-more-detail",
    siteName: "Dario Ristić's blog",
    publishedTime: "2017-02-02",
...
Starting a business used to mean writing a 40-page business plan that would take months to complete and become outdated almost immediately. [Ash Maurya](https://ashmaurya.com/) recognized this problem and created the Lean Business Model Canvas as a streamlined alternative.
...
The Lean Canvas distills the most critical elements of a business model onto a single page, focusing on what actually matters: the problems you're solving, who you're solving them for, and how you'll create value. It's based on [Alexander Osterwalder's original Business Model Canvas](https://www.strategyzer.com/business-model-canvas) but tailored specifically for startups operating under uncertainty and with limited resources.
