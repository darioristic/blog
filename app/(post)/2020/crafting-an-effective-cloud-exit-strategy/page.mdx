export const metadata = {
  alternates: {
    canonical: "/2020/crafting-an-effective-cloud-exit-strategy",
    types: {
  ...
  openGraph: {
    type: "article",
    url: "https://darioristic.com/2020/crafting-an-effective-cloud-exit-strategy",
    siteName: "Dario Ristić's blog",
    publishedTime: "2020-08-31",
