export const metadata = {
  alternates: {
    canonical: "/2014/the-ultimate-guide-to-devops",
    types: {
  ...
  openGraph: {
    type: "article",
    url: "https://darioristic.com/2014/the-ultimate-guide-to-devops",
    siteName: "Dario Ristić's blog",
    publishedTime: "2014-11-15",
