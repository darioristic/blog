export const metadata = {
  alternates: {
    canonical: "/2013/building-sezamhosting-server-farm-opensolaris",
    types: {
  ...
  openGraph: {
    type: "article",
    url: "https://darioristic.com/2013/building-sezamhosting-server-farm-opensolaris",
    siteName: "Dario Ristić's blog",
    publishedTime: "2013-12-15",
