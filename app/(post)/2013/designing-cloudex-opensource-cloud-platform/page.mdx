export const metadata = {
  alternates: {
    canonical: "/2013/designing-cloudex-opensource-cloud-platform",
    types: {
  ...
  openGraph: {
    type: "article",
    url: "https://darioristic.com/2013/designing-cloudex-opensource-cloud-platform",
    siteName: "Dario Ristić's blog",
    publishedTime: "2013-11-15",
