export const metadata = {
  alternates: {
    canonical: "/2018/where-technology-and-organizational-change-intersect",
    types: {
  ...
  openGraph: {
    type: "article",
    url: "https://darioristic.com/2018/where-technology-and-organizational-change-intersect",
    siteName: "Dario Ristić's blog",
    publishedTime: "2018-06-15",
