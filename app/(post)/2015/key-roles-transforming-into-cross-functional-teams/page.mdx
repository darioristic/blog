export const metadata = {
  alternates: {
    canonical: "/2015/key-roles-transforming-into-cross-functional-teams",
    types: {
  ...
  openGraph: {
    type: "article",
    url: "https://darioristic.com/2015/key-roles-transforming-into-cross-functional-teams",
    siteName: "Dario Ristić's blog",
    publishedTime: "2015-04-10",
...
If you're new to the concept of cross-functional teams, start with [The Who, What, Why, and How of Cross-Functional Teams](/2015/the-who-what-why-and-how-of-cross-functional-teams) for foundational understanding.
