...
Think about your homepage or landing page. Does it teach users what to do next naturally? Can they discover key features without reading documentation? Every element should guide users toward their goal.

### For SaaS Products

Your app's first view should be like World 1-1. The most important action should be obvious. Optional features can be discovered through exploration. Make the "right path" obvious, and let power users find the advanced features themselves.

### For Mobile Apps

The best mobile apps work like World 1-1 — they're instantly understandable. Users should be able to figure out core functionality within seconds, with progressive disclosure revealing advanced features as they explore.
