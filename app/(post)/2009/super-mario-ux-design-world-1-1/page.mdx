export const metadata = {
  alternates: {
    canonical: "/2009/super-mario-ux-design-world-1-1",
    types: {
  ...
  openGraph: {
    type: "article",
    url: "https://darioristic.com/2009/super-mario-ux-design-world-1-1",
    siteName: "Dario Ristić's blog",
    publishedTime: "2009-01-15",
...
<YouTube
  videoId="zRGRJRUWafY"
  title="Super Mario Bros World 1-1 Design Analysis by Miyamoto and Tezuka"
/>
