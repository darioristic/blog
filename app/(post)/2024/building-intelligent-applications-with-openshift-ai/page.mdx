export const metadata = {
  alternates: {
    canonical: "/2024/building-intelligent-applications-with-openshift-ai",
    types: {
  ...
  openGraph: {
    type: "article",
    url: "https://darioristic.com/2024/building-intelligent-applications-with-openshift-ai",
...
<YouTube
  videoId="OXFy59Or1rM"
  title="Ristić - How OpenShift AI is revolutionizing business | TechHosted"
/>
