export const metadata = {
  alternates: {
    canonical: "/2022/product-vs-service-it-companies-transform",
    types: {
  ...
  description:
    "How service-based IT companies are forced to rapidly transform, embracing MVP, Agile, DevOps, and Platform Engineering. Discover four principles to transform transactional engagements into Strategic IT Partnerships that deliver real business value.",
  openGraph: {
    type: "article",
    url: "https://darioristic.com/2022/product-vs-service-it-companies-transform",
