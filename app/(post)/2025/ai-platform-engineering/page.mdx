...
export const metadata = {
  ...
  alternates: {
    canonical: "/2025/ai-platform-engineering",
    types: {
  ...
  openGraph: {
    ...
    description:
      "Platform engineering evolves beyond Kubernetes—AI Platform Engineering provides abstractions for LLM models, RAG, vector databases, and intelligent infrastructure.",
    images: [{ url: "/og/ai-platform-engineering" }],
    type: "article",
    url: "https://darioristic.com/2025/ai-platform-engineering",
