export const metadata = {
  alternates: {
    canonical: "/2016/understanding-the-lean-business-model-for-startups",
    types: {
  ...
  openGraph: {
    type: "article",
    url: "https://darioristic.com/2016/understanding-the-lean-business-model-for-startups",
    siteName: "Dario Ristić's blog",
    publishedTime: "2016-06-15",
