export const metadata = {
  alternates: {
    canonical: "/2023/why-i-founded-a-cloud-native-company-as-a-teal-organization",
    types: {
  ...
  openGraph: {
    type: "article",
    url: "https://darioristic.com/2023/why-i-founded-a-cloud-native-company-as-a-teal-organization",
...
Let me start by explaining what I mean by "Teal." The term comes from [Frederic Laloux's book "Reinventing Organizations"](https://www.reinventingorganizations.com/), which describes organizational evolution through color-coded stages.
...
This might sound utopian, but it's not. Companies like [Buurtzorg](https://www.buurtzorg.com/) (healthcare), [Morning Star](https://www.morningstarco.com/) (food processing), and [Patagonia](https://www.patagonia.com/) operate on Teal principles while being highly successful commercially.
